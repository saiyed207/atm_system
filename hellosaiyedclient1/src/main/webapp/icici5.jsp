        ...
        if (withdrawAmount > 0) {
            ...
            if (balance >= withdrawAmount) {
                ...
                try (Connection connection = DriverManager.getConnection(jdbcUrl, dbUsername, dbPassword)) {
                    String updateQuery = "UPDATE users SET balance = ? WHERE pin = ?";
...
%>
                <script>
                    // Redirect to icici6.jsp
                    window.location.href = "icici6.jsp";
                </script>
<%
            } else {
                // Insufficient balance
                response.sendRedirect("icici6.jsp?insufficientBalance=true");
            }
        } else {
            // Invalid withdrawal amount
            response.sendRedirect("icici6.jsp?invalidAmount=true");
        }
    }
