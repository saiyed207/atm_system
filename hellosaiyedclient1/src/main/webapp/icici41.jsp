...
<title>Insert title here</title>
  ...
  <!--   -->
    ...
    <p id="com1"><b>ICICI BANK ATM</b></p></div>
        <div class="screen" style="background-color:darkblue;">
          ...
          <div id="pincrt">
            ...
            <p id="user23" style="margin-top:-10px; color:yellow; font-size:20px; margin-left:-20px;">Balance:  <%= request.getAttribute("balance") %> </p>
            <p id="user23" style="color:yellow; font-size:20px; margin-left:-40px;">          Welcome:  <%= request.getAttribute("accountHolder") %><br> </p>
    ...
    function redirectToWithdraw() {
        ...
        window.location.href = "icici51.jsp";
    }
</script>
